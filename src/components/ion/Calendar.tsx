  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-8 transition-transform duration-300 ease-in-out",
        ...
        day: "h-8 w-8 p-0 font-normal aria-selected:bg-primary rounded-radius hover:bg-primary-container focus:primary-focus transition-colors ease-in-out duration-200 transform hover:scale-105 focus:scale-105",
        day_range_end: "day-range-end",
        day_selected: "bg-primary text-on-primary transition-colors duration-200",
        day_today:
          "bg-primary-container text-on-primary-container aria-selected:text-on-primary transition-colors duration-200",
      ...
      components={{
        IconLeft: () => (
          <CaretLeft className="h-4 w-4 transition-transform duration-200 ease-in-out hover:translate-x-1" />
        ),
        IconRight: () => (
          <CaretRight className="h-4 w-4 transition-transform duration-200 ease-in-out hover:translate-x-1" />
        ),
      }}
